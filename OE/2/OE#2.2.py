'''Design a simple python program that allows a user to create, modify, and delete phone object from the list of mobile phone objects

Steps:
1. Create the phone class
2. define attributes and methods
3. modify phone properties
4. delete phone attributes 9delte object properties)
5. delete phone object
6. create main menu
...
new_writing = writing(input())
writngs .append(new_writing)'''
